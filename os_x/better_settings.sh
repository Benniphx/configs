...
# Forked from https://mths.be/osx by Mathias Bynens
...
# Refresh the existing sudo timestamp
while true; do
  sudo -n true
  sleep 60
  kill -0 "$$" || exit
...
# Install the theme for iTerm2
# open "$HOME/configs/os_x/iterm2/tmnb_asyrjasalo.itermcolors"
